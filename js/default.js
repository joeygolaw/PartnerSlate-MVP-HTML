/* Toggle Panels */ $(".toggle").click(function() {
	$(this).siblings(".ps-panel-list").toggleClass("hidden");
	$(this).parent().toggleClass("toggled");
	});

/* Closable Panels */ $(".closable").click(function() {
	$(this).remove();
	});
/* Clear All Closables */ $(".clear-all-closable").click(function() {
...
/*Anchor Smooth-Scroll*/ $(function(){$("a[href*=#]:not([href=#])").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var target=$(this.hash);target=target.length?target:$("[name="+this.hash.slice(1)+"]");if(target.length){$("html,body").animate({scrollTop:target.offset().top},480);return false;}}});});
